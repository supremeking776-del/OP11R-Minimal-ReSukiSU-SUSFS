...
class MinimalBuildTests(unittest.TestCase):
    ...
    def test_build_fails_closed_and_uploads_auditable_artifacts(self):
        ...
        for assertion in (
            ...
            '_assert_y CONFIG_KSU_SUSFS_HAS_MAGIC_MOUNT',
            '_assert_y CONFIG_KSU_SUSFS_SUS_PATH',
            '_assert_y CONFIG_KSU_SUSFS_SUS_MOUNT',
            '_assert_y CONFIG_KSU_SUSFS_AUTO_ADD_SUS_KSU_DEFAULT_MOUNT',
            '_assert_y CONFIG_KSU_SUSFS_AUTO_ADD_SUS_BIND_MOUNT',
            '_assert_y CONFIG_KSU_SUSFS_SUS_KSTAT',
            '_assert_y CONFIG_KSU_SUSFS_TRY_UMOUNT',
            '_assert_y CONFIG_KSU_SUSFS_AUTO_ADD_TRY_UMOUNT_FOR_BIND_MOUNT',
            ...
            '_assert_not_y CONFIG_KSU_SUSFS_SUS_OVERLAYFS',
            '_assert_not_y CONFIG_KSU_SUSFS_SUS_SU',
